...
const AccountSettings = ({ setStudent,isPopUp }) => {
  ...
  return (
    <div className={`absolute rounded-xl right-[8px] top-[49px] shadow-2xl bg-[#f7f8f8] justify-center transition-all duration-300 ease-in-out ${isPopUp? "w-[250px]" : "w-0 hidden opacity-5 bg-emerald-600"}`}>
