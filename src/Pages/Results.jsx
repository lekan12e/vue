...
const StudentResultsTable = ({ student }) => {
  ...
  return (
    <div className='bg-[#ECF0F5] min-h-screen w-full p-7 gap-2'>
      <h1 className='font-poppins text-2xl sm:text-4xl font-semibold mb-8'>Results</h1>
      <div className='w-full text-center m-5'>
        <h1 className='font-poppins text-red-400 text-xl sm:text-2xl'>{student.name}</h1>
      </div>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead>
            <tr>
              ...
              <th className="px-4 sm:px-6 py-3 text-left font-poppins text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">Test</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            ...
            <tr>
              <td className="px-4 sm:px-6 py-4 font-poppins font-bold" colSpan="4">Overall Average</td>
              <td className="px-4 sm:px-6 py-4 font-poppins font-bold">{averageMark}</td>
            </tr>
          </tbody>
        </table>
      </div>
